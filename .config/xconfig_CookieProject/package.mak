...
override PKGDIR = xconfig_CookieProject
...
package/%.xdc.inc package/%_xconfig_CookieProject.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_CookieProject" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,28FP .dlls: CookieProject.p28FP

-include package/cfg/CookieProject_p28FP.mak
-include package/cfg/CookieProject_p28FP.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/CookieProject_p28FP.dep
endif
CookieProject.p28FP: package/cfg/CookieProject_p28FP.xdl
	@


ifeq (,$(wildcard .libraries,28FP))
CookieProject.p28FP package/cfg/CookieProject_p28FP.c: .libraries,28FP
endif

package/cfg/CookieProject_p28FP.c package/cfg/CookieProject_p28FP.h package/cfg/CookieProject_p28FP.xdl: override _PROG_NAME := CookieProject.x28FP
package/cfg/CookieProject_p28FP.c: package/cfg/CookieProject_p28FP.cfg
package/cfg/CookieProject_p28FP.xdc.inc: package/cfg/CookieProject_p28FP.xdl
package/cfg/CookieProject_p28FP.xdl package/cfg/CookieProject_p28FP.c: .interfaces

clean:: clean,28FP
	-$(RM) package/cfg/CookieProject_p28FP.cfg
	-$(RM) package/cfg/CookieProject_p28FP.dep
	-$(RM) package/cfg/CookieProject_p28FP.c
	-$(RM) package/cfg/CookieProject_p28FP.xdc.inc

clean,28FP::
	-$(RM) CookieProject.p28FP
.executables,28FP .executables: CookieProject.x28FP

CookieProject.x28FP: |CookieProject.p28FP

-include package/cfg/CookieProject.x28FP.mak
CookieProject.x28FP: package/cfg/CookieProject_p28FP.o28FP 
	$(RM) $@
	@$(MSG) lnk28FP $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.C28_float.rootDir)/bin/cl2000 -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 -z  -o $@ package/cfg/CookieProject_p28FP.o28FP   package/cfg/CookieProject_p28FP.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.C28_float.rootDir)/lib/libc.a
	
CookieProject.x28FP: export C_DIR=
CookieProject.x28FP: PATH:=$(ti.targets.C28_float.rootDir)/bin/;$(PATH)
CookieProject.x28FP: Path:=$(ti.targets.C28_float.rootDir)/bin/;$(PATH)

CookieProject.test test,28FP test: CookieProject.x28FP.test

CookieProject.x28FP.test:: CookieProject.x28FP
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 CookieProject.x28FP.test
else
	@$(MSG) running $<  ...
	$(call EXEC.CookieProject.x28FP, ) 
endif

clean,28FP::
	-$(RM) $(wildcard .tmp,CookieProject.x28FP,*)


clean:: clean,28FP

clean,28FP::
	-$(RM) CookieProject.x28FP
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
CookieProject_p28FP.o28FP,copy : package/cfg/CookieProject_p28FP.o28FP
CookieProject_p28FP.s28FP,copy : package/cfg/CookieProject_p28FP.s28FP

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_CookieProject
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_CookieProject.tar.dep
endif
package/rel/xconfig_CookieProject/xconfig_CookieProject/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_CookieProject/xconfig_CookieProject/package/package.rel.xml: package/build.cfg
package/rel/xconfig_CookieProject/xconfig_CookieProject/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_CookieProject/xconfig_CookieProject/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_CookieProject.tar: package/rel/xconfig_CookieProject.xdc.inc package/rel/xconfig_CookieProject/xconfig_CookieProject/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_CookieProject.xdc.inc,package/rel/xconfig_CookieProject.tar.dep)


release release,xconfig_CookieProject: all xconfig_CookieProject.tar
clean:: .clean
	-$(RM) xconfig_CookieProject.tar
	-$(RM) package/rel/xconfig_CookieProject.xdc.inc
	-$(RM) package/rel/xconfig_CookieProject.tar.dep
